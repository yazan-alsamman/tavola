                  ...
                  Padding(
                    ...
                    child: Obx(() {
                      ...
                      return Column(
                        crossAxisAlignment: CrossAxisAlignment.stretch,
                        children: [
                          if (controller.showWaitlistCard) ...[
                            WaitlistFullTablesCard(
                              isJoined: controller.canCancelWaitlist,
                              isBusy: waitlistBusy,
                              onJoin: controller.joinWaitlist,
                              onCancel: controller.cancelWaitlist,
                            ),
                            const SizedBox(
