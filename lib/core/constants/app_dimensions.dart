class AppDimensions {
  ...
  static const double floorPlanContainerHeight = 520.0;
  static const double floorPlanMapMinScale = 1.0;
  static const double floorPlanMapMaxScale = 2.4;
  static const double floorPlanZonePillHeight = 34.0;
  static const double floorPlanZonePillDotSize = 10.0;
  static const double floorPlanChairSize = 7.0;
  static const double floorPlanRoomRadius = 22.0;
  static const double floorPlanBottomBarHeight = 18.0;
  static const double floorPlanRoomTopFactor = 0.20;
  static const double floorPlanRoomBottomFactor = 0.80;
  static const double floorPlanLeftRoomEndFactor = 0.49;
  static const double floorPlanRightRoomStartFactor = 0.51;
  ...
  static const double floorPlanEntranceBottomOffset = 38.0;
  static const double floorPlanEntranceLabelBottomOffset = 50.0;
  static const double floorPlanLegendTopOffset = 52.0;
  static const double floorPlanPillsEndInset = 96.0;
